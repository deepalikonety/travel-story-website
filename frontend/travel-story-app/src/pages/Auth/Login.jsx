      ...
      <div className='container h-screen flex items-center justify-center px-60 mx-auto'>
        <div className='w-2/4 h-[90vh] flex items-end bg-login-bg-img bg-cover bg-center rounded-lg p-30 z-50'>
          <div className='bg-gradient-to-r from-pink-200 to-blue-300'>
            <h4 className='text-4xl  text-blue-500 text-center md:text-3xl font-semibold leading-[58px]'>
              Capture Your Memories 
            </h4>
            <p className='text-[15px] text-pink-500 text-center  font-semibold leading-6 pr-7 mt-4'>
              Record your travel experiences and memories in your  very own personal travel journal.
            </p>
          </div>
        </div>
