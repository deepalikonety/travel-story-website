import ADD_STORY_IMG from "../assets/image/add-story.svg";
import NO_SEARCH_DATA_IMG from "../assets/image/no-search.svg";
...
export const getEmptyCardMessage=(filterType)=>{
  switch(filterType){
    ...
    case "date":
      ...
      default:
        return `Start creating your first Travel Story ! Click the 'Add' button to reminisce those memories. Let's get started....`
  }
};
